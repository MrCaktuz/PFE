...
<div class="container">
    <section class="section">
        ...
        <div class="section-content flex-wrap">
            ...
            <div class="idCard">
                <img src="" alt="photo de profil" class="idCard-photo">
                <a href="/user/id" class="idCard-link">Plus d'infos</a>
                <div class="idCard-content">
                    <p class="idCard-title">test</p>
                    <p class="idCard-subTitle">test</p>
                    <p class="idCard-mail">test</p>
                    <p class="idCard-phone">test</p>
                </div>
            </div>
        </div>
    </section>
